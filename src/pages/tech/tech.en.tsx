...
export default function TechEn() {
  return (
    <>
      ...
      />
      <Icon
        href="https://developer.android.com/tools/sdk"
      ...
      <Icon
        href="https://developer.mozilla.org/docs/Web/XML/XML_introduction"
      ...
      <ul>
        ...
        <li><a href="https://www.image-line.com/fl-studio/">FL Studio</a></li>
