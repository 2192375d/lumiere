export default function SmartAir() {
  return (
    <section>
      ...
      <br />
      An Android App dedicated to help kid understand and handle Asthma.
      <br />
      <ul>
        <li><a href="https://github.com/Kyaw-Thiha/b07-project">github repo</a></li>
      </ul>
      <h3>tools/methodologies used throughout the project</h3>
      This project is complete through a team of 5 people, utilizing the following tools/
      <ul>
      ...
      <br />
      <ul>
        <li>https://github.com/2192375d</li>
